...
<br>
    ...
    <div id="containerContact">
	    <div class="container-fluid text-center">
	    	<span class="font-lemonada"><h1>Adoption Form <span class="glyphicon glyphicon-envelope"></span></h1></span>
	    	<div class="row">
		        <div class="col-md-8">
		                ...
		                <div class="row">
		                    <div class="col-md-6">
		                        ...
		                        <div class="form-group">
		                            ...
		                            <div class="input-group">
		                                <span class="input-group-addon"><span class="glyphicon glyphicon-heart-empty"></span>
		                                </span>   
		                            	<input type="text" class="form-control" id="pet" name="pet" placeholder="Enter Pet name" required="required" />
		                            </div> 
		                        </div>	
...
include_once("config.php");
   if(isset($_POST['submit'])) {	
    ...
    $query="INSERT INTO adopt (Name,Pet,Message,Num) VALUES('$name','$age','$email','$number')";
...
mysqli_close($mysqli);}?>
		        ...
		        <div class="col-md-4">
		            <form>
		            <legend><span class="glyphicon glyphicon-globe"></span> Note</legend>
		            <address><br>
		                Fill out the following form. We will forward your request to corresponding partner shelter. They will contact you to further proceed with the application<br>For any queries feel free to contact:
